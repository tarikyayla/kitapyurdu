...
class Kitap:
    def __init__(self,id,kitap_adi,yazar_adi,yayinevi,kapak,desc,link,fiyat):
        self.id = id
...
array = []
for id,kitap in enumerate(kitaplar):
    try:
        ...
        array.append(Kitap(id,kitap_adi,yazar_adi,yayinevi,kapak,desc,link,fiyat))
